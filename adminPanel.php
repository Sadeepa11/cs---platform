...
<body class="container-fluid">
    <div class="col-12 vh-100">
        <div class="row">
            ...
            <div class="d-none d-lg-none d-md-none d-xl-none col-7  vh-100 fixed" id="smNav"
                style="background-color: #e46161; z-index:1;">
                ...
                <div class="row">
                    ...
                    <div class="col-11  mt-5 link actived" id="dashboard">
                        <div class="row">
                            ...
                            <label class="col-7 fs-5   linkTxt" style="cursor: pointer;"
                                onclick="changeView2('d');">Dashboard</label>
                        </div>
                    ...
                    <div class="col-11 link " id="users">
                        <div class="row">
                            ...
                            <label class="col-7 fs-5   linkTxt" style="cursor: pointer;"
                                onclick="changeView2('mp');">Posts</label>
                        </div>
                    </div>
                    <div class="col-11  link " id="chat">
                        <div class="row">
                            ...
                            <label class="col-7 fs-5   linkTxt" style="cursor: pointer;"
                                onclick="changeView2('c');">Chat</label>
                        </div>
                    </div>
                    <div class="col-11 logOut ">
                        <div class="row">
                            <div class="col-5 fs-4 logOutImg text-end"><i class="bi bi-box-arrow-left"
                                    style="cursor: pointer;"></i></div>
                            <label class="col-7 fs-5   logOutTxt" style="cursor: pointer;" onclick="logOut();">Log
                                Out</label>
                        </div>
            ...
            <div class="d-none d-lg-block d-md-block d-xl-block col-lg-3 col-md-3 col-xl-3  vh-100 fixed"
                style="background-color: #e46161;">
            ...
            <div class="  col-lg-9 col-md-9 col-xl-9 col-sm-12 vh-100 offset-lg-3 offset-md-3 offset-xl-3 offset-sm-0"
                id="d">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 card">
                                <div class="row">
                                    ...
                                    <div class="col-5 crd2 text-secondary mb-5"><i class="bi bi-postcard-heart"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-4 card">
                                <div class="row">
                                    ...
                                    <div class="col-5 crd2 text-secondary mb-5"><i class="bi bi-person-fill-gear"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 tr mt-3">
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <div class="col-2 text-center text-success fs-6"><i class="bi bi-toggle-on"
                                            onclick="changeStatus('<?php echo $data['email']; ?>');"></i></div>
                                    <?php

                                        } else { ?>

                                    <div class="col-2 text-center text-danger fs-6"><i class="bi bi-toggle-off"
                                            onclick="changeStatus('<?php echo $data['email']; ?>');"></i></div>
                                    <?php
                                        }
            ...
            <div class=" d-none  col-lg-9 col-md-9 col-xl-9 col-sm-12 vh-100 offset-lg-3 offset-md-3 offset-xl-3 offset-sm-0"
                id="mp">
                <div class="row">
                    <div class="fixed-start fs-1 d-lg-none d-md-none d-xl-none d-flex">
                        <i class="bi bi-list-ul" onclick="changeView();"></i>
                            ...
                            <div class="row">
                                <div class="col-12 tr mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-2 text-start"><a href="<?php echo $data["link"]; ?>"><i
                                                    class="bi bi-eye text-primary"></i></a></div>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <div class="col-2 text-center text-success fs-6"><i class="bi bi-toggle-on"
                                                id="on" onclick="changeImgStatus('<?php echo $data['id']; ?>');"></i>
                                        </div>
                                        <?php
                                        ...
                                        <div class="col-2 text-center text-danger fs-6"><i class="bi bi-toggle-off"
                                                id="off" onclick="changeImgStatus('<?php echo $data['id']; ?>');"></i>
                                        </div>
                                        <?php
                                            }
